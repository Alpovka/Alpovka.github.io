...
const OfferCard = ({ offer, fetchStatus }: OfferCardProp) => {
          ...
          >
            ...
            <div className=" flex space-x-4 max-[450px]:space-x-2 items-center">
              ...
              {!toggleEditMode ? (
                ...
                <button
                  type="submit"
                  className="button1 max-[600px]:text-xs bg-jobzDarkBlue hover:bg-jobzBlue flex items-center space-x-4 justify-center"
                >
                  Sumbit
